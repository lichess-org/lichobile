    ...
    return layout.free(
      ...
      <div class="aboutBody native_scroller page">
        ...
        <ul>
          ...
          <li>Lichess would not exist without the thousands of hours of time from volunteers, both from {externalLink('website devs', 'https://github.com/lichess-org/lila/graphs/contributors')} and {externalLink('mobile devs', 'https://github.com/veloce/lichobile/graphs/contributors')}, who create new features and/or bugs, as well as our administrative team, who police the site and help with long-term vision.</li>
