...
const AboutScreen: Mithril.Component<{}, {}> = {
  ...
  onremove() {},
  view() {
    const header = headerWidget('About')
    return layout.free(header, aboutBody())
  }
}
