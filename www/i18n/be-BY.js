export default {
  ...
  "opponentLeftChoices": "Супернік пакінуў гульню. Можаш залічыць яму паразу ці пачакаць яго",
  ...
  "games": "Гульні",
  "forum": "Форум",
  "xPostedInForumY": "%1$s апублікавана на форуме %2$s",
  ...
  "siteDescription": "Бясплатныя он-лайн шахматы. Гуляй у шахматы з зручным інтэрфэйсам. Без рэгістрацыі, без рэклямы, без дадатковых праграм. Гуляй у шахматы з камп'ютарам, сябрамі ці выпадковым супернікам.",
  "teams": "Каманды",
  ...
  "xStartedFollowingY": "%1$s пачалі сачыць %2$s",
  "more": "Больш",
  ...
  "xLeftANoteOnY": "%1$s пакінуў нататку аб %2$s",
  "xCompetesInY": "%1$s спаборнічаюць у %2$s",
  "xAskedY": "%1$s адказаў %2$s",
  "xAnsweredY": "%1$s адказаў на %2$s",
  "xCommentedY": "%1$s пракамэнтаваў %2$s",
  "victory": "Перамога!",
  "timeline": "У сярбоў",
  ...
  "yourPerfTypeRatingIsRating": "Ваш %1$s рэйтынг %2$s.",
  "youAreBetterThanPercentOfPerfTypePlayers": "Вы мацней %1$s гульцоў у %2$s.",
  ...
  "analysisShapesHowTo": "Ужывайце Shift+левую кнопку мышы ці правую кнопку, каб маляваць кружкі і стрэлкі на дошцы",
