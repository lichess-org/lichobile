export default {
  ...
  "opponentLeftChoices": "Vaš protivnik je možda napustio partiju. Možete proglasiti pobjedu ili čekati.",
  ...
  "games": "Partije",
  "forum": "Forum",
  "xPostedInForumY": "%1$s je pisao na forumskoj temi %2$s",
  ...
  "siteDescription": "Besplatni internetski šah. Igrajte šah s čistim interfejsom. Registracija nije obavezna, nema reklama, ne zahtijevaju se dodaci za preglednik. Igrajte protiv računara, prijatelja ili slučajnih protivnika.",
  "teams": "Ekipe",
  "allTeams": "Sve ekipe",
  "newTeam": "Nova ekipa",
  "myTeams": "Moje ekipe",
  ...
  "xJoinedTeamY": "%1$s se pridružio ekipi %2$s",
  "xCreatedTeamY": "%1$s je sastavio ekipu %2$s",
  ...
  "xAnsweredY": "%1$s je odgovorio %2$s",
  "xCommentedY": "%1$s je komentarisao %2$s",
  "victory": "Pobjeda!",
  ...
  "youAreBetterThanPercentOfPerfTypePlayers": "Bolji ste nego %1$s od %2$s igrača.",
  ...
  "analysisShapesHowTo": "Pritisni shift+klik ili desni klik za crtanje krugova i strelica na ploči.",
