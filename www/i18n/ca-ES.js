export default {
  ...
  "emailIsOptional": "El correu electrònic és opcional. Lichess l'utilitzarà per restablir la contrasenya si l\\'oblides.",
  ...
  "itWasNotRequiredForYourRegistration": "No es requeria per al teu registre.",
  ...
  "nbGames:one": "%s Partides",
  "nbGames:other": "%s Partides",
  ...
  "youHaveNbSecondsToMakeYourFirstMove:one": "Disposes de %s segons per realitzar el teu primer moviment!",
  "youHaveNbSecondsToMakeYourFirstMove:other": "Disposes de %s segons per realitzar el teu primer moviment!",
