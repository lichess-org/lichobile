export default {
  ...
  "rank": "Pořadí",
  "rankX": "Pořadí: %s",
  "rankIsUpdatedEveryXMinutes": "Pořadí je aktualizováno každých %s minut",
  ...
  "usernameInvalid": "Neplatné uživatelské jméno. Použijte pouze písmena, číslice, podtržítka a pomlčky.",
  "usernameStartNoNumber": "Uživatelské jméno nesmí začínat číslem.",
  ...
  "nextCaptureOrPawnMoveInXHalfMoves:one": "%s půltahu do dalšího braní nebo tahu pěšcem (vynulování pravidla 50ti tahů)",
  ...
  "nbGames:few": "Zobrazit všech %s partií",
  "nbGames:other": "%s partií",
  "nbBookmarks:one": "%s záložka",
  "nbBookmarks:few": "Záložky: %s",
  ...
  "nbGamesWithYou:one": "%s hra s Vámi",
  "nbGamesWithYou:few": "%s hry s Vámi",
  "nbGamesWithYou:other": "%s her s Vámi",
  ...
  "youHaveNbSecondsToMakeYourFirstMove:one": "Máte %s sekundu na provedení prvního tahu!",
  "youHaveNbSecondsToMakeYourFirstMove:few": "Máte %s sekundy na provedení prvního tahu!",
  "youHaveNbSecondsToMakeYourFirstMove:other": "Máte %s sekund na provedení prvního tahu!",
  ...
  "nbForumPosts:few": "%s Příspěvků na fóru",
