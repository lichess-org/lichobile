export default {
  ...
  "shareThisUrlToLetSpectatorsSeeTheGame": "Στείλτε αυτήν τη διεύθυνση για να επιτρέψτε σε θεατές να δουν το παιχνίδι",
  ...
  "loadingEngine": "Φόρτωση μηχανής ...",
  "cloudAnalysis": "Ανάλυση συννέφου",
  "goDeeper": "Βαθύτερα",
  ...
  "averageRatingX": "Mέση βαθμολογία: %s",
  ...
  "maybeIncludeMoreGamesFromThePreferencesMenu": "Ίσως να συμπεριλάβετε περισσότερα παιχνίδια από το μενού προτιμήσεων;",
  "openingExplorer": "Εξερευνητής ανοιγμάτων και τελειωμάτων",
  "xOpeningExplorer": "%s εξερευνητής ανοιγμάτων",
  "winPreventedBy50MoveRule": "H νίκη εμποδίζεται από τον κανόνα των 50 κινήσεων",
  "lossSavedBy50MoveRule": "Ήττα αποτρέπεται από τον κανόνα των 50 κινήσεων",
  "allSet": "Εφαρμογή!",
  "importPgn": "Εισαγωγή PGN",
  "delete": "Διαγραφή",
  "deleteThisImportedGame": "Διαγραφή εισαγόμενης παρτίδας;",
  "replayMode": "Λειτουργία επανάληψης αναπαραγωγής",
  "realtimeReplay": "Σε πραγματικό χρόνο",
  "byCPL": "Με CPL",
  "openStudy": "Άνοιγμα μελέτης",
  "enable": "Ενεργοποίηση",
  "bestMoveArrow": "Καλύτερη κίνηση βέλος",
  ...
  "signUp": "Εγγραφή",
  "computersAreNotAllowedToPlay": "Δεν επιτρέπουμε στους υπολογιστές και παίκτες με υποβοήθηση υπολογιστή να παίζουν στο Lichess. Παρακαλούμε μη δεχτείτε βοήθεια από σκακιστικούς υπολογιστές, βάσεις δεδομένων ή άλλους παίκτες όσο παίζετε εδώ. Επίσης σημειώστε πως αποθαρρύνoυμε την δημιουργία πολλών λογαριασμών και υπερβολή σε αυτό θα καταλήξει σε αποκλεισμό.",
  "games": "Παιχνίδια",
  "forum": "Φόρουμ",
  ...
  "emailIsOptional": "Το ηλ. ταχυδρομείο είναι προαιρετικό. Το Lichess θα το χρησιμοποιήσει μόνο σε περίπτωση που ξεχάσετε τον κωδικό σας για την επαναφορά του.",
  ...
  "thisPlayerArtificiallyIncreasesTheirRating": "Αυτός ο παίκτης αυξάνει/μειώνει τεχνητά τη βαθμολογία",
  ...
  "importGameExplanation": "Κατά την επικόλληση παιχνιδιού PGN δημιουργείται μια περιηγήσιμη αναπαραγωγή, \nανάλυση με υπολογιστή, συνομιλία παιχνιδιού και ένα κοινόχρηστο URL.",
  ...
  "tournamentPairingsAreNowClosed": "Οι αντιστοιχίσεις πρωταθλημάτων είναι τώρα κλειστές.",
  "standByX": "Αναμένετε %s, αντιστοίχιση παικτών, ετοιμαστείτε!",
  "youArePlaying": "Παίζετε τώρα!",
  "winRate": "Ποσοστό νίκης",
  "berserkRate": "Ποσοστό μπερσερκ",
  "performance": "Επίδοση",
  "tournamentComplete": "Πρωτάθλημα ολοκληρώθηκε",
  "movesPlayed": "Κινήσεις που παίχτηκαν",
  ...
  "averageOpponent": "Μέσος αντίπαλος",
  ...
  "gameCompletionRate": "Ποσοστό ολοκλήρωσης παιχνιδιού: %s",
  "profile": "Προφίλ",
  ...
  "troll": "Εμπαιγμός",
  "other": "Άλλου",
  "reportDescriptionHelp": "Κάντε επικόλληση σύνδεσμο για το παιχνίδι(α) και εξηγήστε τι είναι παράξενο στη συμπεριφορά του χρήστη. Μην πείτε απλά «επειδή κλέβει», πείτε μας πως καταλήξατε σε αυτήν τη γνώμη. Η αναφορά σας θα επεξεργαστεί πιο γρήγορα αν είναι γραμμένη στα αγγλικά.",
  "by": "από τον %s",
  ...
  "chessPieceSymbol": "Σύμβολο κομματιού στο σκάκι",
  ...
  "howDoYouMovePieces": "Πώς μετακινείτε τα κομμάτια;",
  "clickTwoSquares": "Κάντε κλικ στα δύο τετράγωνα",
  "dragPiece": "Σύρετε ένα κομμάτι",
  "bothClicksAndDrag": "Κάντε κλικ και σύρετε",
  ...
  "letOtherPlayersInviteYouToStudy": "Επιτρέψτε άλλους παίκτες να σας προσκαλούν στην μελέτη",
  "sound": "Ήχος",
  ...
  "playOfflineComputer": "Υπολογιστής",
  "opponent": "Αντίπαλος",
  "learnMenu": "Εκμάθηση",
  "community": "Κοινότητα",
  "tools": "Εργαλεία",
  ...
  "error.email_different": "Αυτή είναι η υπάρχουσα διεύθυνση ηλ.ταχυδρομείου σας",
  "blindfoldChess": "Τυφλό σκάκι (αόρατα κομμάτια)",
  "zenMode": "Zεν λειτουργία",
  ...
  "simulClockHint": "Ρολόι Φίσερ. Όσους περισσότερους παίκτες αναλάβετε, τόσο περισσότερο χρόνο ίσως χρειαστείτε.",
  ...
  "confirmResignationAndDrawOffers": "Επιβεβαίωση εγκατάλειψης και αποδοχής ισοπαλίας",
  "inputMovesWithTheKeyboard": "Εισάγετε κινήσεις με το πληκτρολόγιο",
  "letOtherPlayersMessageYou": "Επιτρέψτε άλλους παίκτες να σας στέλνουν μηνύματα",
  "castleByMovingTheKingTwoSquaresOrOntoTheRook": "Ροκέ μετακινώντας το βασιλιά δύο τετράγωνα, ή πάνω στον πύργο",
  "castleByMovingTwoSquares": "Ροκέ μετακινώντας ανά δύο τετράγωνα",
  "castleByMovingOntoTheRook": "Ροκέ μετακινώντας πάνω στον πύργο",
  ...
  "kidModeExplanation": "Αυτό έχει σχέση με την ασφάλεια. Στην λειτουργία για παιδιού, απενεργοποιούνται όλες οι επικοινωνίες της ιστοσελίδας. Ενεργοποιήστε το για τα παιδιά σας και τους σχολικούς μαθητές, για την προστασία τους από άλλους διαδικτυακούς χρήστες.",
  "inKidModeTheLichessLogoGetsIconX": "Στην λειτουργία παιδιού, το λογότυπο του lichess παίρνει ένα εικονίδιο %s, έτσι ώστε να γνωρίζετε ότι τα παιδιά σας είναι ασφαλή.",
  "enableKidMode": "Ενεργοποίηση λειτουργίας παιδιού",
  "disableKidMode": "Απενεργοποίηση λειτουργίας παιδιού",
  "security": "Ασφάλεια",
  "thisIsAListOfDevicesThatHaveLoggedIntoYourAccount": "Αυτή είναι μια λίστα των συσκευών που έχουν συνδεθεί στο λογαριασμό σας. Ανακαλέστε τις συνεδρίες που δεν αναγνωρίζετε.",
  ...
  "zeroAdvertisement": "Μηδέν διαφήμιση",
  ...
  "pieceSet": "Επιλογή κομματιού",
  "embedInYourWebsite": "Ενσωματώστε στην ιστοσελίδα σας",
  "usernameAlreadyUsed": "Αυτό το όνομα χρήστη είναι ήδη σε χρήση, παρακαλώ δοκιμάστε ένα άλλο.",
  "usernameInvalid": "Μη έγκυρο όνομα χρήστη. Παρακαλούμε χρησιμοποιήστε μόνο γράμματα, αριθμούς, χαρακτήρα υπογράμμισης και παύλα.",
  "usernameStartNoNumber": "Το όνομα χρήστη δεν πρέπει να ξεκινάει με έναν αριθμό.",
  ...
  "nextCaptureOrPawnMoveInXHalfMoves:other": "Επόμενο κόψιμο ή κίνηση πιονιού σε %s μισές-κινήσεις (Απόσταση μηδενισμού μετρητή 50 κινήσεων)",
  ...
  "lessThanNbMinutes:one": "Λιγότερο από ένα λεπτό",
  "lessThanNbMinutes:other": "Λιγότερο από %s λεπτά",
  "playedXTimes:one": "Παίχτηκε %s φορά",
  "playedXTimes:other": "Παίχτηκε %s φορές",
  "youHaveNbSecondsToMakeYourFirstMove:one": "Έχετε %s δευτερόλεπτα για να κάνετε τη πρώτη σας κίνηση!",
  "youHaveNbSecondsToMakeYourFirstMove:other": "Έχετε %s δευτερόλεπτα για να κάνετε τη πρώτη σας κίνηση!",
  ...
  "blocks:one": "%s αποκλείσεις",
  "blocks:other": "%s αποκλείσεις",
  "nbForumPosts:one": "%s δημοσίευση φόρουμ",
  "nbForumPosts:other": "%s δημοσιεύσεις φόρουμ",
  "nbPerfTypePlayersThisWeek:one": "Ένας %2$s παίκτης αυτή την εβδομάδα.",
  "nbPerfTypePlayersThisWeek:other": "%1$s %2$s παίκτες αυτή την εβδομάδα.",
