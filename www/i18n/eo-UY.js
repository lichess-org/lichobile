export default {
  ...
  "yourPerfTypeRatingIsRating": "Via taksado je %1$s estas %2$s.",
  ...
  "usernameInvalid": "Nevalida uzantnomo. Bonvolu uzu nur leterojn, nombrojn, substrekon kaj streketon.",
  "usernameStartNoNumber": "Ĉi tiu uzantnomo devas ne komenci kun numero.",
  ...
  "nbGamesWithYou:one": "%s ludoj kun vi",
  ...
  "nbFollowers:one": "%s sekvantoj",
  "nbFollowers:other": "%s abonantoj",
  "nbFollowing:one": "%s sekvatoj",
  "nbFollowing:other": "%s sekvatoj",
  "lessThanNbMinutes:one": "Malpli ol %s minutoj",
  "lessThanNbMinutes:other": "Malpli ol %s minutoj",
  "playedXTimes:one": "Ludita %s-foje",
  "playedXTimes:other": "Ludita %s-foje",
  "youHaveNbSecondsToMakeYourFirstMove:one": "Vi havas %s sekundojn por fari vian unuan movon!",
  "youHaveNbSecondsToMakeYourFirstMove:other": "Vi havas %s sekundojn por fari vian unuan movon!",
  ...
  "availableInNbLanguages:one": "Havebla en %s lingvoj!",
