export default {
  ...
  "showThreat": "Mostrar la amenaza",
  "inLocalBrowser": "en el navegador local",
  "toggleLocalEvaluation": "Evaluación local",
  "move": "Movimiento",
  "variantLoss": "Movimiento perdedor",
  "variantWin": "Movimiento ganador",
  ...
  "rankIsUpdatedEveryXMinutes": "La clasificación se actualiza cada %s minutos",
  ...
  "importGameExplanation": "Al pegar el PGN de una partida, se obtiene una repetición navegable, un análisis por ordenador, un chat de juego y una URL para compartir.",
  ...
  "youArePlaying": "¡Está jugando!",
  "winRate": "Porcentaje de victorias",
  "berserkRate": "Tasa de berserk",
  "performance": "Actuación",
  "tournamentComplete": "Torneo finalizado",
  ...
  "pleaseVotePuzzle": "Ayuda a Lichess a mejorar a través de tu votación, usando las flechas arriba o abajo:",
  "thankYou": "¡Gracias!",
  "ratingX": "Valoración: %s",
  ...
  "notes": "Notas",
  "typePrivateNotesHere": "Escribe aquí las notas privadas",
  ...
  "xAnsweredY": "%1$s respondió %2$s",
  "xCommentedY": "%1$s comentó %2$s",
  "victory": "¡Victoria!",
  "defeat": "Derrota",
  "xVsYinZ": "%1$s contra %2$s en %3$s",
  ...
  "error.email_different": "Esta es la misma dirección de correo electrónico que tiene actualmente",
  ...
  "aboutSimulRealLife": "El concepto de simultáneas en Lichess se toma de la vida real, donde el anfitrión va de mesa en mesa para hacer sus movimientos.",
  ...
  "yourPerfTypeRatingIsRating": "Tu puntuación de %1$s es %2$s.",
  "youAreBetterThanPercentOfPerfTypePlayers": "Eres mejor que el %1$s de los jugadores en %2$s.",
  ...
  "analysisShapesHowTo": "Presiona Mayús+clic o clic derecho para dibujar círculos y flechas en el tablero.",
  ...
  "castleByMovingTwoSquares": "Moviendo el rey dos casillas",
  ...
  "alternativelyYouCanX": "O también puede %s.",
  ...
  "builtForTheLoveOfChessNotMoney": "Construido por amor al ajedrez, no al dinero",
  ...
  "usernameInvalid": "Nombre de usuario no válido. Por favor, utilice sólo letras, números, guión bajo y guión.",
  "usernameStartNoNumber": "El nombre de usuario no puede empezar con un número.",
  "usernameUnacceptable": "Este nombre de usuario no es válido.",
  "directlySupportLichess": "Apoyar directamente a Lichess",
  "playChessInStyle": "Jugar al ajedrez con estilo",
  "chessBasics": "Fundamentos de ajedrez",
  "coaches": "Entrenadores",
  "invalidPgn": "PGN no válido",
  ...
  "mateInXHalfMoves:other": "Mate en %s medio movimientos",
  "nextCaptureOrPawnMoveInXHalfMoves:one": "Siguiente captura o peón mueve en %s medio movimiento (distancia a cero del contador de 50 movimientos)",
  "nextCaptureOrPawnMoveInXHalfMoves:other": "Siguiente captura o peón mueve en %s medio movimientos (distancia a cero del contador de 50 movimientos)",
  ...
  "youHaveNbSecondsToMakeYourFirstMove:one": "¡Dispone de %s segundos para hacer su primer movimiento!",
  "youHaveNbSecondsToMakeYourFirstMove:other": "¡Dispone de %s segundos para hacer su primer movimiento!",
  ...
  "nbPerfTypePlayersThisWeek:one": "Un jugador de %2$s esta semana.",
  "nbPerfTypePlayersThisWeek:other": "Un jugador de %2$s esta semana.",
