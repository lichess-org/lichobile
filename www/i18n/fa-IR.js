export default {
  ...
  "toInviteSomeoneToPlayGiveThisUrl": "برای دعوت کردن حریف این آدرس سایت را برای او بفرستید",
  "gameOver": "پایان بازی",
  ...
  "opponentLeftChoices": "حریف مقابل شما بازی را ترک کرده است. شما می توانید پیروزی خود را اعلام کنید, اعلام تساوی کنید یا منتظر او بمانید",
  "makeYourOpponentResign": "شکست حریف را به دلیل ترک بازی اعلام کنید",
  ...
  "computerAnalysisAvailable": "تحلیل گر کامپیوتر موجود است",
  "analysis": "تحلیل",
  "depthX": "عمق %s",
  "usingServerAnalysis": "استفاده از تحلیل سرور",
  "loadingEngine": "در حال بارگذاری موتور ...",
  "cloudAnalysis": "تحلیل ابری",
  "goDeeper": "عمیق تر برو",
  "showThreat": "تهدید را نشان بده",
  "inLocalBrowser": "در مرورگر موضعی",
  "toggleLocalEvaluation": "ارزیابی موضعی تغییر وضعیت",
  "move": "حرکت کن",
  "pawnMove": "حرکت پیاده",
  "capture": "بزن",
  "winning": "بردن",
  ...
  "noGameFound": "بازیی یافت نشد",
  "openingExplorer": "باز کردن جستجوگر",
  "realtimeReplay": "زمان واقعی",
  ...
  "games": "بازی ها",
  "forum": "انجمن",
  "xPostedInForumY": "%1$s در فروم %2$s پست کرد",
  ...
  "email": "ایمیل",
  "emailIsOptional": "ایمیل ضروری نیست. زمانی که رمز عبور خود را فراموش کنید لایچس از این ایمیل استفاده میکند تا شما رمز جدیدی دریافت کنید",
  ...
  "inbox": "صندوق پیام",
  "chatRoom": "اتاق گپ",
  "loginToChat": "وارد شوید تا چت کنید",
  ...
  "siteDescription": "بازی شطرنج آنلاین رایگان. همین حالا شطرنج بازی کنید. بدون نیاز به ثبت نام، بدون تبلیغات، بدون نیاز به افزونه. بازی با کامپیوتر، دوستان و یا حریفان تصادفی.",
  "teams": "تیم‌ها",
  "allTeams": "همه تیم‌ها",
  "newTeam": "تیم جدید",
  "myTeams": "تیم‌های من",
  ...
  "xCreatedTeamY": "%1$s تیم %2$s را ساخت",
  ...
  "xStartedFollowingY": "%1$s کاربر %2$s را دنبال می‌کند",
  "more": "بیشتر",
  "memberSince": "عضویت",
  ...
  "nbPlayers:one": "%s نفر بازیکنان حاضر",
  "nbPlayers:other": "%s نفر بازیکنان حاضر",
  "nbGames:one": "%s بازی",
  ...
  "youHaveNbSecondsToMakeYourFirstMove:one": "شما برای انجام اولین حرکت خود فقط  %s ثانیه فرصت دارید!",
  "youHaveNbSecondsToMakeYourFirstMove:other": "شما برای انجام اولین حرکت خود فقط  %s ثانیه فرصت دارید!",
