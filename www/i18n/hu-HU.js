export default {
  ...
  "opponentLeftChoices": "Az ellenfél elhagyta a játékot. Feladhatod a nevében, vagy várhatsz rá.",
  ...
  "theFirstPersonToComeOnThisUrlWillPlayWithYou": "Az első ember aki ezt a linket használja játékba fog lépni veled.",
  ...
  "draw": "Döntetlen",
  "currentGames": "Éppen zajló játékok",
  ...
  "signUp": "Regisztráció",
  "computersAreNotAllowedToPlay": "Számítógépek és számítógép segítségét igénybe vevő játékosok nem játszhatnak. Kérünk játék közbe ne vegyél igénybe segítséget sakk programoktól, adatbázisoktól, vagy más játékosoktól. Több fiók készítése és használata egyszerre az oldalról való kitiltást vonja maga után.",
  "games": "Játszmák",
  "forum": "Fórum",
  ...
  "usernameOrEmail": "Felhasználónév vagy jelszó",
  "password": "Jelszó",
  ...
  "chatRoom": "Csevegő",
  "loginToChat": "Jelentkezz be a chateléshez",
  ...
  "thisPlayerArtificiallyIncreasesTheirRating": "Ez a játékos mesterségesen növeli/csökkenti a pontszámát",
  ...
  "bookmarkThisGame": "Játszma hozzáadása a könyvjelzőkhöz",
  "search": "Keresés",
  ...
  "siteDescription": "Ingyenes online sakk játék. Sakkozz letisztult kezelőfelületen. Nem szükséges regisztráció vagy pluginok, és hirdetéseket sem kell nézned. Sakkozz a számítógéppel, barátokkal vagy véletlenszerű ellenfelekkel.",
  "teams": "Csapatok",
  ...
  "captcha.fail": "Kérjük, oldd meg a sakk feladványt.",
  ...
  "xStartedFollowingY": "%1$s követni kezdte a következő játékost:  %2$s",
  "more": "Több",
  ...
  "bewareTheGameIsRatedButHasNoClock": "Időmérés nélküli, de rangsorolt meccs!",
  "training": "Gyakorlás",
  ...
  "puzzleOfTheDay": "A nap feladványa",
  ...
  "troll": "Trollkodás",
  "other": "Egyéb",
  "reportDescriptionHelp": "Másold be a játék(ok) linkjét, és magyarázd el mi volt a probléma a játékos viselkedésével. Ne csak annyit írj hogy \"csalt\\\", próbáld elmondani hogyan jöttél rá. A jelentésed hamarabb feldolgozásra kerül ha angolul írod.",
  "by": "%s által",
  "thisTopicIsNowClosed": "Ez a téma jelenleg zárt.",
  "theming": "Kinézet",
  "donate": "Támogatás",
  "blog": "Blog",
  ...
  "xCompetesInY": "%1$s részt vesz a(z) %2$s versenyen",
  ...
  "usernameInvalid": "Érvénytelen felhasználói név. A név csak betűkből, számokból, alulvonásból és gondolatjelből állhat.",
  "usernameStartNoNumber": "A felhasználói név nem kezdődhet számmal.",
  ...
  "nbPlayers:one": "%s csatlakozott játékos",
  "nbPlayers:other": "%s csatlakozott játékos",
  "nbGames:one": "%s Játék",
  "nbGames:other": "%s Játék",
  "nbBookmarks:one": "%s könyvjelző",
  "nbBookmarks:other": "%s könyvjelzők",
  "nbDays:one": "%s nap",
  "nbDays:other": "%s nap",
  "nbHours:one": "%s óra",
  "nbHours:other": "%s óra",
  ...
  "nbFollowers:other": "%s követők",
  "nbFollowing:one": "%s követett",
  "nbFollowing:other": "%s követett",
  "lessThanNbMinutes:one": "Kevesebb mint %s perc",
  "lessThanNbMinutes:other": "Kevesebb mint %s perc",
  "playedXTimes:one": "%s alkalommal játszott",
  "playedXTimes:other": "%s alkalommal játszott",
  "youHaveNbSecondsToMakeYourFirstMove:one": "%s másodperced van, hogy megtedd az első lépést!",
  "youHaveNbSecondsToMakeYourFirstMove:other": "%s másodperced van, hogy megtedd az első lépést!",
  "nbGamesInPlay:one": "%s meccs zajlik épp",
  "nbGamesInPlay:other": "%s meccs zajlik épp",
