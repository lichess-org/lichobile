export default {
  ...
  "opponentLeftChoices": "Հակառակորդը լքել է խաղը։ Դուք կարող եք ստիպել նրան հանձնվել կամ սպասել նրան։",
  ...
  "siteDescription": "Անճար օնլայն շախմատ: Խաղացցեք հաճելի ինտերֆեյսով, առանց գրանցման և գովազդի: Խաղացեք համակարգչի, ընկերների կամ անծանոթների հետ:",
  "teams": "Թիմեր",
  ...
  "biographyDescription": "Պատմեք Ձեր մասին. թե ինչն եք սիրում շախմատում, որոնք են Ձեր սիրելի սկբնախաղերը, պարտյաները, շախմատիստները…",
  "human": "Մարդ",
  "computer": "Համակարգիչ",
  "side": "Կողմ",
  "clock": "ժամացույց",
  ...
  "menu": "Մենյու",
  "castling": "Տեղափոխություն",
  "whiteCastlingKingside": "Սպիտակները О-О",
  "whiteCastlingQueenside": "Սպիտակները О-О-О",
  "blackCastlingKingside": "Սեւերը О-О",
  "blackCastlingQueenside": "Սեւերը О-О-О",
  "watchGames": "Դիտել խաղեր",
  "watch": "Դիտել",
  "internationalEvents": "Միջազգային իրադարձություննեռր",
  ...
  "youHaveNbSecondsToMakeYourFirstMove:one": "Դուք ունեք %s վայրկյան Ձեր առաջին քայլը կատարելու համար։",
  "youHaveNbSecondsToMakeYourFirstMove:other": "Դուք ունեք %s վայրկյան Ձեր առաջին քայլը կատարելու համար։",
