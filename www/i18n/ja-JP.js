export default {
  ...
  "computerAnalysisAvailable": "コンピュータ解析が可能です",
  "analysis": "棋譜解析",
  "depthX": "深度 %s",
  ...
  "recentGames": "最近のゲーム",
  "topGames": "トップのゲーム",
  "masterDbExplanation": "1952 年から 2016 年まで、FIDEレーティング 2200 以上の 実戦 200 万局",
  ...
  "rank": "ランク",
  "rankX": "ランク: %s",
  "rankIsUpdatedEveryXMinutes": "ランクは %s 分ごとに更新します。",
  "gamesPlayed": "局をプレイ",
  "cancel": "キャンセル",
  "timeOut": "時間切れ",
  ...
  "colorPlaysCheckmateInOne": "%s 番; １手でチェックメイト",
  "retry": "もう一度",
  "reconnecting": "再接続",
  "onlineFriends": "接続中の友達",
  ...
  "areYouSureYouEvenRegisteredYourEmailOnLichess": "ほんとうに以前にメールアドレスを登録しましたか？",
  "itWasNotRequiredForYourRegistration": "メールアドレスは登録に必須ではありません。",
  ...
  "usernameInvalid": "無効なユーザー名です。使えるのは英数字、アンダースコア、ダッシュだけです。",
  "usernameStartNoNumber": "ユーザー名の最初は数字であってはいけません。",
  ...
  "youHaveNbSecondsToMakeYourFirstMove:other": "%s 秒以内に初手を指してください",
  "nbGamesInPlay:other": "%s 局プレイ中",
  "maximumNbCharacters:other": "最大: %s 文字",
  "blocks:other": "%s 名をブロック",
  "nbForumPosts:other": "%s フォーラム投稿",
  "nbPerfTypePlayersThisWeek:other": "この 1 週間の %1$s 参加者 %2$s 人。",
