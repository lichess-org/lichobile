export default {
  ...
  "youAreBetterThanPercentOfPerfTypePlayers": "당신은 상위 %1$s 의 %2$s 성적을 기록했습니다.",
  ...
  "areYouSureYouEvenRegisteredYourEmailOnLichess": "이 메일 주소가 맞습니까? 기록을 찾을 수 없습니다.",
  "itWasNotRequiredForYourRegistration": "이 메일이 아닌 것 같습니다.",
  ...
  "nbFollowers:other": "%s 팔로워",
  "nbFollowing:other": "%s 팔로잉",
  "lessThanNbMinutes:other": "%s분 미만",
  "playedXTimes:other": "%s회 플레이",
  "youHaveNbSecondsToMakeYourFirstMove:other": "%s초 안에 첫 수를 놓으세요!",
