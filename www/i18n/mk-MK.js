export default {
  ...
  "closeAccountExplanation": "Дали сте сигурни дека сакате да го затворите профилот? Затворањето на профилот ќе биде трајно. Нема да можите да се најавите и вашиот профил нема да биди достапен.",
