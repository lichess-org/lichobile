export default {
  ...
  "openingExplorer": "Åpningsutforsker & database",
  "blunders": "Bukker",
  "mistakes": "Feil",
  ...
  "email": "E-post",
  "emailIsOptional": "E-post er valgfritt. Lichess vil bruke den til å tilbakestille passordet ditt hvis du glemmer det.",
  ...
  "rematch": "Revansj",
  "rematchOfferSent": "Tilbud om revansj sendt",
  "rematchOfferAccepted": "Tilbud om revansj godtatt",
  "rematchOfferCanceled": "Tilbud om revansj trukket tilbake",
  ...
  "thisPlayerUsesChessComputerAssistance": "Denne spilleren bruker computer",
  ...
  "siteDescription": "Gratis nettsjakk. Spill sjakk nå, i et enkelt og rent format. Ingen registrering, ingen reklame, ingen programtillegg nødvendig. Spill sjakk mot datamaskinen, venner, eller tilfeldige motstandere.",
  "teams": "Lag",
  "allTeams": "Alle lag",
  "newTeam": "Nytt lag",
  "myTeams": "Mine lag",
  ...
  "aConfirmationIsRequiredToJoin": "En bekreftelse kreves for å bli med i denne klanen",
  ...
  "averageElo": "Gjennomsnittsrating",
  "location": "Sted",
  ...
  "colorPlaysCheckmateInOne": "%s setter sjakk matt i ett trekk",
  "retry": "Prøv igjen",
  ...
  "pieceDestinations": "Brikkedestinasjoner (gyldige trekk og fortrekk)",
  ...
  "playOnTheBoardOffline": "Spill frakoblet, på enheten",
  "playOfflineComputer": "Spill frakoblet mot datamaskinen",
  "opponent": "Motstander",
  ...
  "areYouSureYouEvenRegisteredYourEmailOnLichess": "Er du sikker på at du har registrert e-post adressen din på lichess?",
  ...
  "xJoinsY": "%1$s ble med %2$s",
  "xLikesY": "%1$s liker %2$s",
  "quickPairing": "Raskt pairing",
  "lobby": "Lobby",
  "yourScore": "Din poengsum: %s",
  "language": "Språk",
  "background": "Bakgrunn",
  "boardGeometry": "Brett geometri",
  "boardTheme": "Brett tema",
  "boardSize": "Brett størrelse",
  "pieceSet": "Brikkesett",
  "embedInYourWebsite": "Embed på nettsiden din",
  "usernameAlreadyUsed": "Brukernavnet er allerede i bruk, prøv et annet et.",
  "usernameInvalid": "Ugyldig brukernavn. Vennligst bare bruk bokstaver, tall, under- og bindestrek.",
  "usernameStartNoNumber": "Brukernavnet kan ikke begynne med et tall.",
  ...
  "nbGamesWithYou:other": "%s partier med deg",
  "nbWins:one": "%s seier",
  ...
  "youHaveNbSecondsToMakeYourFirstMove:one": "Du har %s sekunder på deg til å gjøre første trekk!",
  "youHaveNbSecondsToMakeYourFirstMove:other": "Du har %s sekunder på deg til å gjøre første trekk!",
  "nbGamesInPlay:one": "%s partier spilles",
  "nbGamesInPlay:other": "%s partier spilles",
  "maximumNbCharacters:one": "Maksimum: %s bokstaver.",
  "maximumNbCharacters:other": "Maksimum: %s bokstaver.",
  "blocks:one": "%s blokkeringer",
  "blocks:other": "%s blokkeringer",
  "nbForumPosts:one": "%s Foruminnlegg",
  "nbForumPosts:other": "%s Foruminnlegg",
  "nbPerfTypePlayersThisWeek:one": "En %2$s spiller denne uken.",
  "nbPerfTypePlayersThisWeek:other": "%1$s %2$s spiller denne uken.",
