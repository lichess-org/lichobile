export default {
  ...
  "joinTheGame": "Bli med",
  "whitePlays": "Kvit sitt trekk",
  "blackPlays": "Svart sitt trekk",
  "opponentLeftChoices": "Den andre spelaren kan ha forlete partiet. Du kan velja mellom å krevja siger eller remis, eller du kan venta litt til.",
  ...
  "analysis": "Analyse",
  "openingExplorer": "Opningsutforskar & opningsbok",
  "blunders": "Bukk",
  "mistakes": "Mistak",
  "inaccuracies": "Sleiv",
  "moveTimes": "Tidsbruk per trekk",
  "flipBoard": "Snu brettet",
  "threefoldRepetition": "Trekkgjentaking (tre tilfelle av identisk stilling)",
  ...
  "youNeedAnAccountToDoThat": "Du må registrera deg inn for å gjera dette",
  ...
  "username": "Brukarnavn",
  "usernameOrEmail": "Brukarnamn eller epost",
  "password": "Passord",
  ...
  "drawOfferDeclined": "Remistilbodet blei avslått",
  "drawOfferAccepted": "Remistilbodet blei godteke",
  ...
  "yourOpponentOffersADraw": "Din motstandar tilbyr remis",
  "accept": "Godta",
  "decline": "Avslå",
  ...
  "takebackPropositionDeclined": "Framlegget om å gjera om trekket blei avvist",
  "takebackPropositionAccepted": "Framlegget om å gjera om trekket blei godteke",
  "takebackPropositionCanceled": "Framlegget om å gjera om trekket blei avbrote",
  ...
  "siteDescription": "Fritt tilgjengeleg nettsjakk. Spel sjakk på ei rein nettside uten registrering, reklame eller tillegg. Spel sjakk mot datamaskin, vener eller tilfeldige motspelarar.",
  "teams": "Lag",
  "allTeams": "Alle lag",
  "newTeam": "Nytt lag",
  "myTeams": "Mine lag",
  ...
  "xCreatedTeamY": "%1$s oppretta lag",
  ...
  "captcha.fail": "Vennligst løs sjakkutfordringen.",
  ...
  "favoriteOpponents": "Favorittmotstandre",
  "follow": "Følgj",
  "following": "Følgjer",
  "unfollow": "Bryt",
  "block": "Blokkér",
  ...
  "xStartedFollowingY": "%1$s byrja å følgja %2$s",
  "more": "Meir",
  ...
  "claimDrawOnThreefoldRepetitionAutomatically": "Krev uavgjort etter stillingsgjentagelse automatisk",
  ...
  "biographyDescription": "Fortell om deg selv, hva du liker i sjakk, favorittåpningene dine, favorittparti, favorittspillere…",
  ...
  "xHostsY": "%1$s sender fra %2$s",
  "xJoinsY": "%1$s blir med i %2$s",
  "xLikesY": "%1$s liker %2$s",
  "quickPairing": "Rask paring",
  "lobby": "Lobby",
  ...
  "pieceSet": "Brikkesett",
  "embedInYourWebsite": "Bygg inn i din nettside",
  "usernameAlreadyUsed": "Dette brukernavnet er allerede i bruk, vennligst prøv et annet.",
  "usernameInvalid": "Ugyldig brukernavn. Vennligst bruk kun bokstaver, tall, understreker og bindestreker.",
  "usernameStartNoNumber": "Brukernavnet kan ikke starte med et tall.",
  ...
  "custom": "Egendefinert",
  "nbPlayers:one": "Spelarar: %s",
  "nbPlayers:other": "Spelarar: %s",
  "nbGames:one": "Sjå alle %s parti",
  "nbGames:other": "Sjå alle %s parti",
  ...
  "nbImportedGames:one": "%s Importerte spel",
  "nbImportedGames:other": "%s Importerte spel",
  "nbFollowers:one": "%s følgjesvener",
  "nbFollowers:other": "%s følgjesvener",
  "nbFollowing:one": "%s følgjer",
  "nbFollowing:other": "%s følgjer",
  "lessThanNbMinutes:one": "Mindre enn %s minutt",
  "lessThanNbMinutes:other": "Mindre enn %s minutt",
  "playedXTimes:one": "Spelt %s gonger",
  "playedXTimes:other": "Spelt %s gonger",
  "youHaveNbSecondsToMakeYourFirstMove:one": "Du har %s sekundar på å gjera ditt første trekk!",
  "youHaveNbSecondsToMakeYourFirstMove:other": "Du har %s sekundar på å gjera ditt første trekk!",
  "nbGamesInPlay:one": "%s parti pågår",
  "nbGamesInPlay:other": "%s parti pågår",
  "maximumNbCharacters:one": "Maksimalt: %s bokstavar.",
