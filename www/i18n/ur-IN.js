export default {
  ...
  "xStartedFollowingY": "%1$s اب آپکا پیروکار ہے",
  "more": "مزید",
  "memberSince": "رکنیت",
  ...
  "difficultyHard": "مشکل",
  "xLeftANoteOnY": "%1$s نے %2$s کے لیے نوٹ چھوڑا",
  ...
  "keyMoveBackwardOrForward": "چال اگلیپچھلی",
  "keyGoToStartOrEnd": "چال پہلیآخری",
  "keyShowOrHideComments": "تبصرے دکھائیںچھپائیں",
  "keyEnterOrExitVariation": "متبادل چالیں داخلخارج",
  ...
  "playedXTimes:one": "%s بار کھیلا جا چکا ہے",
  "playedXTimes:other": "%s بار کھیلا جا چکا ہے",
  "youHaveNbSecondsToMakeYourFirstMove:one": "آپ کے پاس چال چلنے کیلیے %s سیکنڈ ہیں",
  "youHaveNbSecondsToMakeYourFirstMove:other": "آپ کے پاس چال چلنے کیلیے %s سیکنڈ ہیں",
