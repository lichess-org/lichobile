export default {
  ...
  "whitePlays": "白方走棋",
  "blackPlays": "黑方走棋",
  "opponentLeftChoices": "对方可能已经离开游戏。你可以选择：取胜、和棋，也可以等待对方走棋。",
  "makeYourOpponentResign": "取胜",
  "forceResignation": "取胜",
  "forceDraw": "和棋",
  "talkInChat": "請在聊天室裡文明一點",
  "theFirstPersonToComeOnThisUrlWillPlayWithYou": "第一个访问该网址的人将与你对弈。",
  "whiteResigned": "白方认输",
  "blackResigned": "黑方认输",
  ...
  "signUp": "注册",
  "computersAreNotAllowedToPlay": "电脑与电脑辅助棋手不允许参加对弈。对弈时，请勿从国际象棋引擎、数据库以及其他棋手那里获取帮助。另外，强烈建议不要创建多个账号；过分地使用多个账号将导致封号。",
  "games": "对局",
  "forum": "论坛",
  "xPostedInForumY": "%1$s发帖：%2$s",
  ...
  "changeEmail": "更换电子邮件",
  "email": "电邮",
  "emailIsOptional": "电子邮件可选填。若您忘记了密码，Lichess将会以电子邮件的方式重置密码。",
  "passwordReset": "重置密码",
  "forgotPassword": "忘记密码？",
  "rank": "排名",
  "gamesPlayed": "盘棋已结束",
  ...
  "exportGames": "导出游戏",
  "ratingRange": "级别范围",
  "thisPlayerUsesChessComputerAssistance": "这位曾经使用过电脑辅助",
  "thisPlayerArtificiallyIncreasesTheirRating": "这位棋手伪造等级",
  "takeback": "悔棋",
  ...
  "backToGame": "返回游戏",
  "siteDescription": "界面清新的免费在线国际象棋平台。不用注册，没有广告，无需插件。快来与电脑、朋友和陌生人一起对战吧！",
  "teams": "团队",
  "allTeams": "所有团队",
  "newTeam": "组建团队",
  "myTeams": "我的团队",
  ...
  "notACheckmate": "没有将死",
  "colorPlaysCheckmateInOne": "%s走棋；一步将杀",
  "retry": "重试",
  "reconnecting": "正在连接",
  "onlineFriends": "在线好友",
  ...
  "areYouSureYouEvenRegisteredYourEmailOnLichess": "您确定您登记过您的（电子）邮箱吗？",
  "itWasNotRequiredForYourRegistration": "登记时是没有需要的。",
  ...
  "nbGames:other": "查看所有%s盘棋",
  "nbBookmarks:other": "%s个收藏",
  "nbDays:other": "%s天",
  "nbHours:other": "%s小时",
  "nbGamesWithYou:other": "与你下过%s盘棋",
  "nbWins:other": "%s胜",
  "nbLosses:other": "%s负",
  "nbDraws:other": "%s和",
